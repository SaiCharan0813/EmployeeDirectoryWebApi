 ...
 useEffect(() => {
  ...
  function filterbyDepartment(department: string) {
    ...
    setfilterEmployees(allEmployees.filter((emp: IEmployee) => {
      if (emp.departmentId.trim().toLowerCase() == department.toLowerCase()) {
        return emp;
      }
    })
    );
  ...
  function filterbyOffice(filterbyOffice: string) {
    ...
    setfilterEmployees(allEmployees.filter((emp: IEmployee) => {
      if (emp.officeId.trim().toLowerCase() == filterbyOffice.toLowerCase()) {
        return emp;
      }
    })
    );
  ...
  function filterbyJobtitle(jobtitle: string) {
    setfilterEmployees(allEmployees.filter((emp: IEmployee) => {
      if (emp.jobTitleId.trim().toLowerCase() == jobtitle.toLowerCase()) {
        return emp;
      }
    })
    );
