...
const FullEmployee: React.FC<props> = ({ employeeId, closeEditform }) => {
  ...
  const [employeePhonenumber, setemployeePhonenumber] = useState<string>(current_emp.contactNumber.toString())
      ...
      <div id="employee-full-details " className={`employee-fulldetails edit-employee-backgroundcolor position-relative $(edits:""?"display-hidden")`}>
        ...
        <div className="details-editing position-relative">
          ...
          <input
            ...
            onChange={event => { setemployeeFirstname(event.target.value); setemployeePrefferedname(event.target.value + employeeLastname) }}
        ...
        <div className="details-editing position-relative">
          ...
          <input
            ...
            defaultValue={current_emp.contactNumber}
          />
